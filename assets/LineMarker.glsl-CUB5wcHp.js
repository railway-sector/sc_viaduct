import{vM as X,GB as Z,GC as ee,Fc as te,Fa as ie,GD as re,GE as ae,Fh as o,Gu as se,FQ as oe,Gt as ne,Fg as z,GF as ce,GG as le,Fd as pe,Ff as de,Fi as he,Gd as ve,Fk as ue,GH as G,GI as N,GJ as me,GK as fe,FU as ge,hr as Se,Fl as Pe,Fm as ye,_ as _e,Fn as W,Fp as R,Fq as ze,Fr as E,Fs as M,FV as we,Fu as xe,Fv as $e,Fx as Te,Ft as be,Fy as V,GL as Ve,GM as U,GN as I,GO as Fe,GP as ke,GQ as Oe,Fz as De,n as p,FA as d,ho as Ce,FX as We,GR as B,r2 as Me,Gl as Le,lh as je,FF as Ae,dp as q,dq as Q,xn as Ge,eH as H,GS as Ne}from"./index-BYdCJpuA.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:w}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(N),S.constants.add("relativeMarkerSize","float",me/G).constants.add("relativeTipLineWidth","float",fe).code.add(o`
