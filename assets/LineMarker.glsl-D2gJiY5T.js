import{vI as X,G5 as K,G6 as ee,EI as te,EG as ie,G7 as re,G8 as ae,EN as o,F_ as se,Fk as oe,FZ as ne,EM as w,G9 as ce,Ga as le,EJ as pe,EL as de,EO as he,FJ as ve,EQ as ue,Gb as A,Gc as G,Gd as me,Ge as fe,Fo as ge,hm as Se,ER as Pe,ES as ye,_ as _e,ET as E,EV as N,EW as we,EX as R,EY as F,Fp as ze,E_ as xe,E$ as $e,F1 as Te,EZ as be,F2 as V,Gf as Ve,Gg as U,Gh as I,Gi as ke,Gj as Oe,Gk as De,F3 as We,n as p,F4 as d,hj as Ce,Fr as Ee,Gl as B,q_ as Fe,FR as Me,ld as je,F9 as Le,dj as q,dk as Y,xj as Ae,eC as J,Gm as Ge}from"./index-D6HyaNEJ.js";function H(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(K,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
