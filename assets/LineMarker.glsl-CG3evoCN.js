import{vL as X,GA as Z,GB as ee,Fb as te,F9 as ie,GC as re,GD as ae,Fg as o,Gt as se,FP as oe,Gs as ne,Ff as w,GE as ce,GF as le,Fc as pe,Fe as de,Fh as he,Gc as ve,Fj as ue,GG as G,GH as N,GI as me,GJ as fe,FT as ge,hr as Se,Fk as Pe,Fl as ye,_ as _e,Fm as C,Fo as E,Fp as we,Fq as R,Fr as L,FU as ze,Ft as xe,Fu as $e,Fw as Te,Fs as be,Fx as V,GK as Ve,GL as U,GM as I,GN as ke,GO as Fe,GP as Oe,Fy as De,n as p,Fz as d,ho as We,FW as Ce,GQ as B,r2 as Le,Gk as Me,lh as je,FE as Ae,dp as q,dq as J,xm as Ge,eH as H,GR as Ne}from"./index-BkKIpdnN.js";function Q(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
